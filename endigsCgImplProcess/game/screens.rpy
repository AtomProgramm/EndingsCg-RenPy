...
screen navigation():
    ...
    vbox:
        ...
        # Now not impl, showing if have at least one ending gain
        if persistent.endingsCgOpen:
            textbutton _("Концовки") action ShowMenu("endings_achivment_meenu")
...
#| Экран концовок #########################################################
#|
#| Показывает достигнуты концовки и приуроченные к ним cg  
